...
export default function NotFound() {
  return (
    <div className="bg-white dark:bg-stone-900 border border-stone-200 dark:border-stone-800 rounded-3xl p-10 sm:p-16 shadow-sm text-center">
      <p className="text-6xl font-black text-[var(--accent)] dark:text-[var(--accent-text-dark)]">
        404
      </p>
      ...
      <Link
        to="/"
        className="mt-8 inline-flex items-center gap-2 bg-[var(--accent)] text-white px-6 py-3 rounded-full font-semibold hover:bg-[var(--accent-hover)] transition"
      >
        <Compass size={18} />
        Back to Home
      </Link>
